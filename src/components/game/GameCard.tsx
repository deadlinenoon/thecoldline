...
const normalizeTeam = (team: RedZoneTeamMetrics | undefined, fallbackId: string): RedZoneTeamMetrics => {
...
export function GameCard({
  ...
  const redZoneMatchup = useMemo<RedZoneMatchup>(() => {
    ...
    return {
      teamA: normalizeTeam(base.teamA, away),
      teamB: normalizeTeam(base.teamB, home),
    };
  }, [matchup, away, home]);
          ...
          <section aria-label="Injuries" className="mt-5">
            ...
            {showInjuries && hasInjuryListings ? (
              <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-2">
                <div>
                  <h5 className="text-xs uppercase tracking-wide text-slate-400">{away} availability</h5>
                ...
                <div>
                  <h5 className="text-xs uppercase tracking-wide text-slate-400">{home} availability</h5>
                  <ul className="mt-2 max-h-56 space-y-2 overflow-y-auto pr-1">
                ...
                <table className="min-w-full divide-y divide-slate-800 text-sm">
                  <thead className="bg-slate-900/80 text-slate-300">
                    <tr>
                      ...
                      <th scope="col" className="px-3 py-2 text-left font-semibold">{away}</th>
                      <th scope="col" className="px-3 py-2 text-left font-semibold">{home}</th>
